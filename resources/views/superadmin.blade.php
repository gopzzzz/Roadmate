          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-header">
                ...
                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#exampleModal">Add SuperAdmin</button>
...
<form method="POST" action="{{url('supadminsert')}}" enctype="multipart/form-data">
...
<input class="form-control" name="password" placeholder="Enter Phone Number" required>
...
<option value="2">Managing Staff</option>
...
<button type="submit" name="submit" class="btn btn-primary">Add</button>
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
					...
					@if($role==1)<td><i class="fa fa-edit edit_sup"  aria-hidden="true" data-toggle="modal" data-id="{{$key->id}}"></i>
				...
				<div class="modal" id="edit_sup" tabindex="-1" role="dialog">
  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
      ...
      <form method="POST" action="{{url('')}}" enctype="multipart/form-data" name="exeedit">
