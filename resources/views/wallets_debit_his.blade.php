                  ...
                  <div class="card-body">
                     <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                           ...
                           $i=1;
                           @endphp
                           @foreach($walldbtthis as $key)
                           <tr>
                              <td>{{$i}}</td>
							  <td>{{$key->name}}</td>
							  <td>{{$key->debit_amount}}</td>
							  <td>{{$key->debited_to}}</td>
                              <td>{{$key->debited_purpose}}</td>
                              <td>
                                <!-- <i class="fa fa-edit editcompackage"  aria-hidden="true" data-toggle="modal" data-id="{{$key->id}}"></i>-->
                                 <i class="fa fa-eye viewwalletdbt"  aria-hidden="true" data-toggle="modal" data-id="{{$key->id}}"></i>
                   ...
                   <div class="modal" id="viewwalletdbt_modal" tabindex="-1" role="dialog">
                        <div class="modal-dialog" role="document">
                           <div class="modal-content">
                              <div class="modal-header">
                                 <h5 class="modal-title">View Wallet Debit History</h5>
                                 ...
                                 <div class="modal-body row">
									 ...
									 <input type="hidden" name="id" id="walldbtid">
									...
									<div class="form-group col-sm-6">
                                       ...
                                       <label class="exampleModalLabel">Debited To</label>
                                       <textarea class="form-control" name="debt" id="debt" ></textarea>
                                    </div>
									<div class="form-group col-sm-6">
                                    
                                       <label class="exampleModalLabel">Purpose</label>
                                       <textarea class="form-control" name="purp" id="purp" ></textarea>
                                    </div>
                                 </div>
