                                 ...
                                 <div class="modal-body row">
								  ...
								  <div class="form-group col-sm-6">
                                    ...
                                    <div class="form-group col-sm-6">
                                      ...
                                      <input type="text" name="dis_amunt" class="form-control"  Placeholder="Enter Offer Amount" oninput="validateAmount(this)" required>
                                    </div>
                                    <div class="form-group col-sm-6">
    ...
    function confirmDelete(offerId) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = "{{ url('shop_offersdelete') }}/" + offerId;
            }
        });
    }
</script>
resources/views/shop_provided_categories.blade.php
@endsection