...
@foreach($invoice as $key)
        ...
        E-Mail:<a href="mailto:info@roadmate.in" style="color: #3364FF; font-family: Arial; " target="_blank">info@roadmate.in</a></th><th  colspan="3" style="font-weight: normal;">Invoice No.<br><b>RM/{{$key->order_id}}/{{ date('y') }}</b></th>
   ...
   <thead>
    <tr>
    <th style="border: 2px solid #000000;" colspan="1">Sl No.</th>
        ...
        <th style=" border: 2px solid #000000;" colspan="6">Amount</th>
    </tr>
</thead>
<tbody>
@php  
...
@foreach($invoice as $key)
    ...
    <tr> 
        ...
        <td style="text-align: right; border-right: 2px solid #000000;border-left: 2px solid #000000;"> {{$key->qty*$key->offer_amount}}</td>
