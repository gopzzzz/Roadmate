                  ...
                  <div class="card-body">
                     <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                           ...
                           $i=1;
                           @endphp
                           @foreach($wallcrdthis as $key)
                           <tr>
                              <td>{{$i}}</td>
							  <td>{{$key->name}}</td>
							  <td>{{$key->credited_amount}}</td>
                              <td>{{$key->purpose}}</td>
                              <td>
                                <!-- <i class="fa fa-edit editcompackage"  aria-hidden="true" data-toggle="modal" data-id="{{$key->id}}"></i>-->
                                 <i class="fa fa-eye viewwalletcrd"  aria-hidden="true" data-toggle="modal" data-id="{{$key->id}}"></i>
                   ...
                   <div class="modal" id="viewwalletcrd_modal" tabindex="-1" role="dialog">
                        <div class="modal-dialog" role="document">
                           <div class="modal-content">
                              <div class="modal-header">
                                 <h5 class="modal-title">View Wallet Credit History</h5>
                                 ...
                                 <div class="modal-body row">
									 ...
									 <input type="hidden" name="id" id="wallcrdid">
