...
$totalQuantity += $key->qty;
        $totalSum += $key->qty * $key->selling_rate+ $key->shipping_charge;
        ...
        <td style="text-align: right;">{{$key->selling_rate}}</td>
        <td style="text-align: right;">NOS</td>
        <td style="text-align: right;" colspan="2"><b>{{$key->qty * $key->selling_rate+ $key->shipping_charge}}</b></td>
    </tr>
    @endforeach
<tr>
    <td></td>
