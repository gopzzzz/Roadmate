...
<br>
  ...
  <table class="table table-bordered table-striped table-sm">
    ...
    @if($key->sale_status == 0)
        ...
        @else
            <form method="get" action="{{ route('b2csale_order', ['orderId' => $key->id]) }}">
...
@endif
<td style="width: 50px;">
    <form method="get" action="{{ route('b2corder_invoice', ['orderId' => $key->id]) }}" target="_blank">
    ...
    <div class="row">
    {{ $orders->appends(['order_status' => $statusFilter])->links() }}
